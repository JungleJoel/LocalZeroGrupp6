...
public interface ICommunityService
{
    ...
    Task<MyJoinRequestDTO?> GetMyJoinRequestAsync(Guid userId);

    Task CancelJoinRequestAsync(Guid userId, Guid communityId);

    Task<List<CommunityJoinRequestWithUserDTO>> GetRequestsAsync(Guid managerUserId, Guid communityId);
    ...
    Task<List<CommunityMemberDTO>> GetMembersAsync(Guid communityId, Guid requestingUserId);
}